...
pub(crate) fn add_headers(row: &mut Vec<Cell>, total_bytes_sent: u64, total_bytes_recv: u64, interval: u64) {
...
pub(crate) fn add(row: &mut Vec<Cell>, stream: &PacStream, total_bytes_sent: u64, total_bytes_recv: u64, interval: u64) {
